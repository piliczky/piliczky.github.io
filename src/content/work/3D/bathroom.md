...
<div class="stack gap-4">
    <img 
        src="/assets/3D/Bathroom/Bathroom_Recreation_Day.png" 
...
<div style="aspect-ratio: 16 / 9; width: 100%; margin-top: 1.5rem; margin-bottom: 2rem;">
    <video 
        ...
        style="border-radius: 1.5rem; box-shadow: var(--shadow-lg);"
    >
        <source src="/assets/3D/Bathroom/Piliczky_Gavin_Light.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
</div>
...
<div style="aspect-ratio: 16 / 9; width: 100%; margin-top: 1.5rem; margin-bottom: 2rem;">
    <video 
        ...
        style="border-radius: 1.5rem; box-shadow: var(--shadow-lg);"
    >
        <source src="/assets/3D/Bathroom/Piliczky_Gavin_Jar.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
</div>
...
<div style="aspect-ratio: 16 / 9; width: 100%; margin-top: 1.5rem; margin-bottom: 2rem;">
    <video 
        ...
        style="border-radius: 1.5rem; box-shadow: var(--shadow-lg);"
    >
        <source src="/assets/3D/Bathroom/Piliczky_Gavin_Heater.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
</div>
